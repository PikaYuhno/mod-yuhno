...
export default class Kick {
    ...
    public async run() {
        ...
        const user = this._message.mentions.members.first() || this._message.guild.members.cache.get(this._args[0]);
        this._args.shift();
        ...
        this._message.channel.send(`${Constants.PREFIX_SUCCESS} ${kickedMember.user.tag} was successfully kicked!`);
    }
